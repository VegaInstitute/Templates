...
% Default size A0
% \usepackage[scale=1.15, size=a0]{beamerposter} % use scale from 1.1 to 1.2

% Use custom size to set poster's width and height.
\usepackage[scale=1.15, size=custom, width=120, height=100]{beamerposter} % use scale from 1.1 to 1.2
\usetheme{vegaposter} 
